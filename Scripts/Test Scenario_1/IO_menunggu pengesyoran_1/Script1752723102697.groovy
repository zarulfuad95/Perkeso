...
WebUI.callTestCase(findTestCase('Test Cases/Test Scenario_1/Profil SRB_1'), null)
WebUI.callTestCase(findTestCase('Test Cases/Login page_io user'), null)
...
// Notis Tuntutan
	...
	WebUI.click(findTestObject('Object Repository/NKM/IO/Tugasan Saya/Option_recommend case'))
	WebUI.click(findTestObject('Object Repository/NKM/IO/Tugasan Saya/Select_pengesyoran'))
	WebUI.click(findTestObject('Object Repository/NKM/IO/Tugasan Saya/Option_syor lulus penakat'))
	WebUI.click(findTestObject('Object Repository/NKM/IO/Tugasan Saya/button_semakan domestik'))
	WebUI.setText(findTestObject('Object Repository/NKM/IO/Tugasan Saya/Textarea_catatan'), 'Test ABC')
