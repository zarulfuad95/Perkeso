...
// Get today’s date using your reusable keyword
String todayFormatted = CustomKeywords.'utils.DynamicICGenerator.getTodayDateInFormat'()

// Print for debug
println("Today's Date: " + todayFormatted)

// Use in your field
WebUI.setText(findTestObject('Object Repository/NKM/input_death date'), todayFormatted)
GlobalVariable.tarikhterimaborang =todayFormatted

println("Tarikh Kematian: " + GlobalVariable.tarikhterimaborang)
