...
WebUI.callTestCase(findTestCase('Test Cases/NKM/NOTIS ASAL_NKM'), null)

WebUI.waitForElementPresent(findTestObject("Object Repository/NKM/Profil SRB/Tarikh terima borang"), 0)
WebUI.setText(findTestObject('Object Repository/NKM/Profil SRB/Tarikh terima borang'),'01/07/2025')
...
WebUI.setText(findTestObject('Object Repository/NKM/Senarai orang tanggungan/Input_no kad pengenalan'), KadPengenalan)
